...
Behavior when C<beginE<gt>final> has initial tests for matching and event inclusion.  Testing and documentation may be incomplete.  Note that timestamp discovery doesn't currently support this configuration.
