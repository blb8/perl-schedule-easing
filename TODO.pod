...
(Available with 0.1.4) All functions should be fully supported, included for C<timestamps> calculations.

=head2 Pass type

(Available with 0.1.5) Support C<type=pass> that always includes a matching message.  Will help with faster bailout and to avoid unexpected matching against later easing configurations.
